...
from enterprise_agents.agents.enterprise_tools import build_enterprise_registry
from enterprise_agents.config import Settings, get_settings
from enterprise_agents.core.agent import AgentConfig, ToolCallingAgent
from enterprise_agents.core.llm import LLMClient, build_llm_client
...
from enterprise_agents.security.guardrails import InputGuardrail, OutputGuardrail, make_canary
...
def load_prompt(filename: str) -> str:
    return resources.files("enterprise_agents.prompts").joinpath(filename).read_text(encoding="utf-8")

...
from enterprise_agents.observability.tracing import traced, update_span
...
class OpenAICompatibleClient:
    ...
    @traced(name="llm.chat", span_type="llm")
    def chat(self, messages: list[Message], tools: list[dict] | None = None) -> LLMResponse:
        import openai
        ...
        update_span(usage=usage, model=self.model, provider=self.provider)

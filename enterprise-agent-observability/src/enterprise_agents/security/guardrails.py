...
from enterprise_agents.observability.tracing import traced
...
class InputGuardrail:
    ...
    @traced(name="guardrail.input", span_type="guardrail")
...
class OutputGuardrail:
    ...
    @traced(name="guardrail.output", span_type="guardrail")
    def check(self, text: str) -> GuardrailResult:
        reasons: list[str] = []
        text = text or ""

...
from phoenix_agents.observability.tracing import LLM, set_llm_attributes, traced
...
class OpenAICompatibleClient:
    ...
    def chat(self, messages: list[Message], tools: list[dict] | None = None) -> LLMResponse:
        ...
        set_llm_attributes(
            ...
            invocation_parameters={"temperature": self.temperature,

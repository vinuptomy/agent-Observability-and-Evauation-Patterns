...
from phoenix_agents.observability.tracing import GUARDRAIL, traced
...
class InputGuardrail:
    ...
    @traced(name="guardrail.input", kind=GUARDRAIL)
...
class OutputGuardrail:
    ...
    @traced(name="guardrail.output", kind=GUARDRAIL)
    def check(self, text: str) -> GuardrailResult:
        reasons: list[str] = []
        text = text or ""
